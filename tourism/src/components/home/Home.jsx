...
import uk_tourism_video from '../home/uk_tourism_video.mp4'
      ...
      <div>
        ...
        <div className="absolute top-1/3 text-xl w-1/2">
            <div className= " flex flex-col justify-center items-center leading-none text-white ">
                <p className="text-hero text-6xl font-semibold font-mono tracking-wider">
                    DEVBHOOMI
                </p>
                <br />
        ...
        <div className="mb-12 relative h-fit">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h1 className="reveal text-5xl mx-auto font-semibold leading-normal max-w-5xl">
              Landscapes that will take your breath away, rich history, and
              delicious food, your trip to Uttarakhand will be nothing short of
              unforgettable.
            </h1>
          </motion.div>
        </div>
...
<div className="py-10">
  <div className="container h-fit mx-auto ">
    ...
    <div className=" uppercase mb-4 font-semibold text-4xl">
      <p className="text-center">
      MINI HEAVEN
      </p>
    </div>
  <div className="video-container container h-fit flex justify-center  mx-auto">
  <video className="h-[35rem] w-fit" controls autoPlay muted src={uk_tourism_video}></video>
