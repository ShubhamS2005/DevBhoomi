...
const AutoplayCarousel = () => {
  const images = [
    'https://content.r9cdn.net/rimg/dimg/db/2a/2a8a5680-city-46381-16a45b0105c.jpg?width=1366&height=768&xhint=3892&yhint=1679&crop=true',
        'https://uttarakhandtourism.gov.in/sites/default/files/2021-08/chardham.png',
        'https://uttarakhandtourism.gov.in/sites/default/files/2021-08/Trekking.png',
        'https://uttarakhandtourism.gov.in/sites/default/files/2021-08/Yoga.png',
  ...
  return (
    <div className="relative w-full mt-10 max-w-7xl mx-auto">
      ...
      {/* Navigation Dots */}
      <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 flex space-x-2 mb-3">
        {images.map((_, index) => (
          <div
            key={index}
