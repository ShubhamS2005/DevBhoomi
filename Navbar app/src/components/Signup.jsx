        ...
        <div className="flex relative flex-col justify-between shadow-2xl items-center h-[80vh] w-[50vw] bg-gray-100 pr-[130px] rounded-xl ">
          ...
          <div className="flex gap-8 ">
            <div className="box1 max-w-[50%] rounded-lg ml-28">
              {/* <img
              width={570}
              src="https://e0.pxfuel.com/wallpapers/350/552/desktop-wallpaper-uttarakhand-dehradun.jpg"
              alt="Dev-Bhoomi"
            />
            <h1 className="absolute tracking-wide top-16 left-10">Uttarakhand</h1> */}
          ...
          <div className="flex mb-8 mt-8 justify-center items-center flex-col gap-2 ml-28 ">
